...
public class TungstenSulfideFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_TUNGSTEN_SULFIDE_FLUID_TYPE = register("molten_tungsten_sulfide_fluid",
