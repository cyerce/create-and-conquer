...
public class PlutoniumSulfideFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_PLUTONIUM_SULFIDE_FLUID_TYPE = register("molten_plutonium_sulfide_fluid",
