...
public class ChromiumSulfateFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_CHROMIUM_SULFATE_FLUID_TYPE = register("molten_chromium_sulfate_fluid",
