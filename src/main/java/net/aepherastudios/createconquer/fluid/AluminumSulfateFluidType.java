...
public class AluminumSulfateFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_ALUMINUM_SULFATE_FLUID_TYPE = register("molten_aluminum_sulfate_fluid",
