...
public class UraniumSulfideFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_URANIUM_SULFIDE_FLUID_TYPE = register("molten_uranium_sulfide_fluid",
