...
public class PoloniumSulfideFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_POLONIUM_SULFIDE_FLUID_TYPE = register("molten_polonium_sulfide_fluid",
