...
public class ChromiumSulfideFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_CHROMIUM_SULFIDE_FLUID_TYPE = register("molten_chromium_sulfide_fluid",
