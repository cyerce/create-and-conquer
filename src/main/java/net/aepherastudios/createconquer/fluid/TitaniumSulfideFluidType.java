...
public class TitaniumSulfideFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_TITANIUM_SULFIDE_FLUID_TYPE = register("molten_titanium_sulfide_fluid",
