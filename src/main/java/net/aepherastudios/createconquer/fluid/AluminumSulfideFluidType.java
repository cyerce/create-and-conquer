...
public class AluminumSulfideFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_ALUMINUM_SULFIDE_FLUID_TYPE = register("molten_aluminum_sulfide_fluid",
