...
public class UraniumSulfateFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_URANIUM_SULFATE_FLUID_TYPE = register("molten_uranium_sulfate_fluid",
