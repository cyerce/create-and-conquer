...
public class PoloniumSulfateFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_POLONIUM_SULFATE_FLUID_TYPE = register("molten_polonium_sulfate_fluid",
