...
public class BismuthSulfateFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_BISMUTH_SULFATE_FLUID_TYPE = register("molten_bismuth_sulfate_fluid",
