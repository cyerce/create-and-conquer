...
public class PlutoniumSulfateFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_PLUTONIUM_SULFATE_FLUID_TYPE = register("molten_plutonium_sulfate_fluid",
