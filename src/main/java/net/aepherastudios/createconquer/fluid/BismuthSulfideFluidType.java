...
public class BismuthSulfideFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_BISMUTH_SULFIDE_FLUID_TYPE = register("molten_bismuth_sulfide_fluid",
