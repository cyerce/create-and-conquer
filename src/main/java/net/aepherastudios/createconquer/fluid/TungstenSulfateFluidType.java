...
public class TungstenSulfateFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_TUNGSTEN_SULFATE_FLUID_TYPE = register("molten_tungsten_sulfate_fluid",
