...
public class AmmoniaFluidType {
    ...
    public static final ResourceLocation AMMONIA_OVERLAY_RL = new ResourceLocation(CreateConquer.MOD_ID, "block/molten_metal_still");

    public static final DeferredRegister<FluidType> FLUID_TYPES =
            DeferredRegister.create(ForgeRegistries.Keys.FLUID_TYPES, CreateConquer.MOD_ID);

    public static final RegistryObject<FluidType> AMMONIA_FLUID_TYPE = register("ammonia_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(AMMONIA_STILL_RL, AMMONIA_FLOWING_RL, AMMONIA_OVERLAY_RL, 0xA1D8C8E5, new Vector3f(216f / 255f, 200f / 255f, 229f / 255f), properties));
    }
