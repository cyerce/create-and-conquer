...
public class TitaniumSulfateFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_TITANIUM_SULFATE_FLUID_TYPE = register("molten_titanium_sulfate_fluid",
