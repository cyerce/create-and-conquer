...
public class ThoriumSulfideFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_THORIUM_SULFIDE_FLUID_TYPE = register("molten_thorium_sulfide_fluid",
