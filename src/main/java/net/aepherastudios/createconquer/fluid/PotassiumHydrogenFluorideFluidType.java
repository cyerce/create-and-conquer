...
public class PotassiumHydrogenFluorideFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_POTASSIUM_HYDROGEN_FLUORIDE_FLUID_TYPE = register("molten_potassium_hydrogen_fluoride_fluid",
