...
public class ThoriumSulfateFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_THORIUM_SULFATE_FLUID_TYPE = register("molten_thorium_sulfate_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(MOLTEN_METAL_STILL_RL, MOLTEN_METAL_FLOWING_RL, MOLTEN_METAL_OVERLAY_RL, 0xA1A06B9D, new Vector3f(160f / 255f, 107f / 255f, 157f/255f), properties));
    }
