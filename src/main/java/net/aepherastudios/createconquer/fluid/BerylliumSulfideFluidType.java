...
public class BerylliumSulfideFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_BERYLLIUM_SULFIDE_FLUID_TYPE = register("molten_beryllium_sulfide_fluid",
