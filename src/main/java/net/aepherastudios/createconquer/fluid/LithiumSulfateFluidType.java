...
public class LithiumSulfateFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_LITHIUM_SULFATE_FLUID_TYPE = register("molten_lithium_sulfate_fluid",
