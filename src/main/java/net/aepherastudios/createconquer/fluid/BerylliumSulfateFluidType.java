...
public class BerylliumSulfateFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_BERYLLIUM_SULFATE_FLUID_TYPE = register("molten_beryllium_sulfate_fluid",
